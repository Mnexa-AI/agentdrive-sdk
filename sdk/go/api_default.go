...
func (r ApiDashboardDashboardGetRequest) Vis(vis string) ApiDashboardDashboardGetRequest {
	r.vis = &vis
	return r
}
...
func (a *DefaultAPIService) DashboardDashboardGetExecute(r ApiDashboardDashboardGetRequest) (string, *http.Response, error) {
	...
	if r.vis != nil {
		...
		var defaultValue string = ""
		parameterAddToHeaderOrQuery(localVarQueryParams, "vis", defaultValue, "form", "")
		r.vis = &defaultValue
	}
	if r.after != nil {
...
/*
DeleteDriveRouteV0DrivesDriveIdDelete Soft-delete the authenticated drive
...
func (r ApiFindV0FindGetRequest) Visibility(visibility string) ApiFindV0FindGetRequest {
...
func (r ApiPutArtifactV0ArtifactsPathPutRequest) XAgentdriveVisibility(xAgentdriveVisibility string) ApiPutArtifactV0ArtifactsPathPutRequest {
	r.xAgentdriveVisibility = &xAgentdriveVisibility
	return r
}
...
func (a *DefaultAPIService) PutArtifactV0ArtifactsPathPutExecute(r ApiPutArtifactV0ArtifactsPathPutRequest) (*ArtifactOut, *http.Response, error) {
	...
	if r.xAgentdriveVisibility != nil {
		parameterAddToHeaderOrQuery(localVarHeaderParams, "x-agentdrive-visibility", r.xAgentdriveVisibility, "simple", "")
	}
...
func (r ApiSearchV0SearchGetRequest) Visibility(visibility string) ApiSearchV0SearchGetRequest {
	r.visibility = &visibility
	return r
}
...
type ApiSettingsUsageSettingsUsageGetRequest struct {
	ctx context.Context
	ApiService *DefaultAPIService
}

func (r ApiSettingsUsageSettingsUsageGetRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.SettingsUsageSettingsUsageGetExecute(r)
}

/*
SettingsUsageSettingsUsageGet Settings Usage
...
and the template hides the cap line in that case.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsUsageSettingsUsageGetRequest
*/
func (a *DefaultAPIService) SettingsUsageSettingsUsageGet(ctx context.Context) ApiSettingsUsageSettingsUsageGetRequest {
	return ApiSettingsUsageSettingsUsageGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *DefaultAPIService) SettingsUsageSettingsUsageGetExecute(r ApiSettingsUsageSettingsUsageGetRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.SettingsUsageSettingsUsageGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/usage"
...
func (r ApiWebSetMetadataWebSetPostRequest) Visibility(visibility string) ApiWebSetMetadataWebSetPostRequest {
	r.visibility = &visibility
	return r
}
...
func (r ApiWebUploadWebUploadPostRequest) Visibility(visibility string) ApiWebUploadWebUploadPostRequest {
	r.visibility = &visibility
	return r
}
