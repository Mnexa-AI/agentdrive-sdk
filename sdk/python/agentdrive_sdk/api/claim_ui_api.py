...
class ClaimUiApi:
    ...
    @validate_call
    def claim_complete_agent_identity_claim_complete_post(
        self,
        claim_attempt_token: StrictStr,
        user_code: StrictStr,
        csrf: StrictStr,
        ...
        :param claim_attempt_token: (required)
        :type claim_attempt_token: str
        ...
        _param = self._claim_complete_agent_identity_claim_complete_post_serialize(
    ...
    @validate_call
    def claim_complete_agent_identity_claim_complete_post_with_http_info(
        self,
        claim_attempt_token: StrictStr,
        user_code: StrictStr,
        csrf: StrictStr,
    ...
    @validate_call
    def claim_complete_agent_identity_claim_complete_post_without_preload_content(
        self,
        claim_attempt_token: StrictStr,
        user_code: StrictStr,
        csrf: StrictStr,
    ...
    def _claim_complete_agent_identity_claim_complete_post_serialize(
        self,
        claim_attempt_token,
        user_code,
        csrf,
        ...
        if claim_attempt_token is not None:
            _form_params.append(('claim_attempt_token', claim_attempt_token))
        if user_code is not None:
            _form_params.append(('user_code', user_code))
        if decision is not None:
            _form_params.append(('decision', decision))
        if org_name is not None:
            _form_params.append(('org_name', org_name))
        if csrf is not None:
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/agent/identity/claim/complete',
    ...
    def claim_page_claim_get(
        ...
        _param = self._claim_page_claim_get_serialize(
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def claim_page_claim_get_with_http_info(
        self,
        code: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def claim_page_claim_get_without_preload_content(
        self,
        code: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _claim_page_claim_get_serialize(
        self,
        code,
        _request_auth,
        _content_type,
