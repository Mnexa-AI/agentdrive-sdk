...
class TestPublicIn(unittest.TestCase):
    """PublicIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicIn:
        """Test PublicIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicIn`
        """
        model = PublicIn()
        if include_optional:
            return PublicIn(
