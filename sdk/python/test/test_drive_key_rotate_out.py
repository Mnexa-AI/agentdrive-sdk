...
class TestDriveKeyRotateOut(unittest.TestCase):
    """DriveKeyRotateOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DriveKeyRotateOut:
        """Test DriveKeyRotateOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DriveKeyRotateOut`
        """
        model = DriveKeyRotateOut()
        if include_optional:
    ...
    def testDriveKeyRotateOut(self):
        """Test DriveKeyRotateOut"""
