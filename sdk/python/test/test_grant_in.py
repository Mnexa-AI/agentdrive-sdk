...
class TestGrantIn(unittest.TestCase):
    """GrantIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantIn:
        """Test GrantIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantIn`
        """
        model = GrantIn()
        if include_optional:
            return GrantIn(
